        ...
        <div class="col-auto m-2 align-items-center">
            @php
                ...
                $profileRoute = $isOwnProfile
                    ? route('myprofile.show', ['id' => $user->id])
                ...
                @if (optional($quest_a->user)->official_certification == 2)
                    <div class="col-auto px-0">
                        <div class="col-auto p-0">
                            <img src="{{ asset('images/logo/official_personal.png') }}" class="avatar-xs ms-2"
                ...
                <div class="d-flex align-items-center ps-0 justify-content-center">
                    <form id="like-form-{{ $quest_a->id }}" class="like-form" data-quest-id="{{ $quest_a->id }}">
                        ...
                        <button type="button" class="btn btn-sm shadow-none ps-0 like-btn">
                            <i
                                class="fa{{ $quest_a->isLiked() ? 's' : 'r' }} fa-heart {{ $quest_a->isLiked() ? 'text-danger' : '' }}"></i>
                        </button>
                    </form>

                    <button class="btn btn-sm p-0 text-center open-likes-modal" data-bs-toggle="modal"
                        data-bs-target="#likes-modal" data-quest-id="{{ $quest_a->id }}">
                        <span class="like-count"
                            data-quest-id="{{ $quest_a->id }}">{{ $quest_a->questLikes->count() }}</span>
                    </button>
        ...
        <div class="col-md ms-3 pt-3 d-none d-sm-block">
            ...
            <div class="row pb-2">
                <div class="d-flex align-items-center ps-0">
                    ...
                    <button class="btn btn-sm p-0 text-center open-likes-modal" data-bs-toggle="modal"
                        data-bs-target="#likes-modal-{{ $quest_a->id }}" data-quest-id="{{ $quest_a->id }}">
                        <span class="like-count"
                            data-quest-id="{{ $quest_a->id }}">{{ $quest_a->likes->count() }}</span>
                    </button>
