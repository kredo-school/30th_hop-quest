            ...
            <div class="profile-container">
                <label class="header d-block mb-3">
                    ...
                    <img id="headerPreview"
                        src="{{ $user->header ? asset('storage/' . $user->header) : asset('images/profiles/header.jpg') }}"
                        alt="Header Image">
                </label>
                ...
                @php
                    $avatarPath = $user->avatar
                        ...
                        : asset('images/profiles/avatar.jpg');
                @endphp
                <img src="{{ $avatarPath }}" class="rounded-circle avatar-xxl" alt="Avatar">
