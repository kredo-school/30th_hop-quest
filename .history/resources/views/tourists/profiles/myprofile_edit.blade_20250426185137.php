                ...
                <label class="header d-block mb-3">
                    ...
                    @php
                        ...
                        if (Str::startsWith($headerPath, 'data:image')) {
                            ...
                            Str::startsWith($headerPath, 'images/') &&
                            file_exists(public_path('storage/' . $headerPath))
                        ) {
                            $headerSrc = asset($headerPath);
                ...
                <label class="avatar">
                    ...
                    @php
                        ...
                        if (Str::startsWith($avatarPath, 'data:image')) {
                            ...
                            Str::startsWith($avatarPath, 'images/') &&
                            file_exists(public_path('storage/' . $avatarPath))
                        ) {
...
<script src="{{ asset('/resources/js/profile_edit.js') }}"></script>
