    ...
    @if ($user)
        <div class="container-fluid px-0">
            <div class="header-container mt-3 px-0">
                <img src="{{ Str::startsWith($user->header, 'data:image') ? $user->header : asset('images/profiles/header.jpg') }}"
                    alt="Header Image" class="w-100" style="height: 470px; object-fit: cover;">
