            ...
            <div class="profile-container">
                <label class="header d-block mb-3">
                    ...
                    <img id="headerPreview"
                        src="{{ Str::startsWith($user->header, ['http', 'data:']) ? $user->header : asset('images/profiles/header.jpg') }}"
                        alt="Header Image">
                </label>
                <label class="avatar">
                    <input type="file" id="avatar" name="avatar" accept="image/*" class="d-none">
                    <img id="avatarPreview"
                        src="{{ Str::startsWith($user->avatar, ['http', 'data:']) ? $user->avatar : asset('images/profiles/avatar.jpg') }}"
                        alt="Avatar Image">
                </label>
                </label>
