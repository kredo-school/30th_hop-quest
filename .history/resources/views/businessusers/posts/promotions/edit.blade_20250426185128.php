                ...
                <div class="col-8 mb-3">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="d-inline ">(<span class="color-red fw-bold">*</span> Required items)
                            <p>
                        </div>
                        <div class="col-2">
                            <button class="btn btn-sm btn-red mb-2 w-100" data-bs-toggle="modal"
                                data-bs-target="#delete-business_promotion{{ $business_promotion->id }}">DELETE</button>
                        </div>
                        @include('businessusers.posts.promotions.modals.delete')
                    </div>
                    <form action="{{ route('promotions.update', $business_promotion->id) }}" method="post"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="title" id="title"
                                    value="{{ old('title', $business_promotion->title) }}" class="form-control">
                                @error('title')
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <label for="business_id" class="form-label fw-bold">Related Business<span
                                        class="color-red">*</span></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <label for="promotion_start" class="form-label">Promotion start date<span
                                        class="color-red">*</span></label>
                                <input type="date" name="promotion_start" id="promotion_start"
                                    value="{{ old('promotion_start', $business_promotion->promotion_start) }}"
                                    class="form-control">
                            </div>
                            <div class="col-6">
                                <label for="promotion_end" class="form-label">Promotion end date<span
                                        class="color-red">*</span></label>
                                <input type="date" name="promotion_end" id="promotion_end"
                                    value="{{ old('promotion_end', $business_promotion->promotion_end) }}"
                                    class="form-control">
                            </div>
                        </div>
                        {{-- Display period --}}
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="date" name="display_start" id="display_start"
                                    value="{{ old('display_start', $business_promotion->display_start) }}"
                                    class="form-control">
                            </div>
                            <div class="col-6">
                                <label for="display_end" class="form-label">Display end date</label>
                                <input type="date" name="display_end" id="display_end"
                                    value="{{ old('display_end', $business_promotion->display_end) }}"
                                    class="form-control">
                            </div>
                        </div>
                        {{-- Introduction --}}
                        ...
                        <div class="row mb-3 ">
                            ...
                            <div class="col-4">
                                <label for="image" class="form-label d-block">Photo upload<span
                                        class="color-red">*</span></label>
                                @if ($business_promotion->image)
                                    ...
                                    @else
                                        <img src="{{ asset($business_promotion->image) }}" alt="#"
                                            class="img-lg mb-2">
                                    @endif
                                @else
                                ...
                                <input type="file" name="image" id="image"
                                    class="form-control form-control-sm w-100 mb-auto p-2">
                            </div>
                            @error('image')
                                <p class="mb-0 text-danger small">{{ $message }}</p>
                            @enderror
                        ...
                        <button class="btn btn-green w-100 ">CHECK</button>
                            ...
                            <div class="col-4">
                                <a
                                    href="{{ route('profile.header', ['id' => $business_promotion->user_id, 'tab' => 'promotions']) }}">
