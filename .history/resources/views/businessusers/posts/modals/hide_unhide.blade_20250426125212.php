{{-- resources/views/businessusers/posts/spots/modals/hide_unhide.blade.php --}}
@if (!$post[‘is_trashed’])
    {{-- DEACTIVATE --}}
            ...
            <div class=“modal-content border-green”>
                ...
                <div class=“modal-footer border-0”>
                    <form action=“{{ route(‘spots . activate’, $post[‘id’]) }}” method=“post”>
                        @csrf
                        @method(‘PATCH’)
                        <button type=“button” data-bs-dismiss=“modal” class=“btn btn-sm
                            btn-outline-green”>Cancel</button>
