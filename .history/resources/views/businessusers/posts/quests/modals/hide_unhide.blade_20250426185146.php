            ...
            <div class="modal-content border-red">
                ...
                <div class="modal-body text-dark">
                    ...
                    <div class="mb-2">
                        ...
                        @else
                            <img src="{{ asset($post['main_image']) }}" alt="{{ $post['title'] }}" class="img-sm">
                        @endif
                    </div>
                    <div>
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('quest.softDelete', $post['id']) }}" method="post">
                        ...
                        <button type="button" data-bs-dismiss="modal"
                            class="btn btn-sm btn-outline-red">Cancel</button>
            ...
            <div class="modal-content border-green">
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('quest.restore', $post['id']) }}" method="post">
                        ...
                        @method('PATCH')
                        <button type="button" data-bs-dismiss="modal"
                            class="btn btn-sm btn-outline-green">Cancel</button>
