                            ...
                            @if ($user->id == Auth::user()->id)
                                ...
                                <div class="col-md-2 col-sm-3 ms-auto">
                                    <a href="{{ Auth::user()->role_id == 1
                                        ? route('myprofile.edit', Auth::user()->id)
                                ...
                                <div class="col-md-2 col-sm-2 ">
                                    @if ($user->isFollowed())
                                        ...
                                        <form action="{{ route('follow.delete', $user->id) }}" method="post">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="btn btn-following fw-bold mb-2 w-100">Following</button>
                                        </form>
                                    @else
                                        {{-- follow --}}
                                                ...
                                                <div class="col-auto mt-3">
                                                    ...
                                                    @if ($follower->follower->id != Auth::user()->id && Auth::user()->role_id == 1)
                                                        @if ($follower->follower->isFollowed())
                                                            {{-- unfollow --}}
                                                            <form
                                                                action="{{ route('follow.delete', $follower->follower->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                                        ...
                                                        @else
                                                            {{-- follow --}}
                                                            <form
                                                                action="{{ route('follow.store', $follower->follower->id) }}"
                                                                method="post">
                                                                @csrf
                                        ...
                                        <div class="row mb-3 align-items-center ">
                                            ...
                                            <ul class="list-group">
                                                @forelse($user->follows as $following)
                                                    <div
                                                        class="row bg-white p-2 mx-5 rounded-4 mb-3 d-flex align-items-center">
                                                        <div class="col-auto">
                                                            {{-- icon/avatar --}}
                                                            <a
