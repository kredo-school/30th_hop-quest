        ...
        <div class="col-9">
            ...
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="col-12 col-md-6 add-spot-container">
                    <form action="{{ route('spots.update', $spot->id) }}" method="POST" class="add-spot-form px-0"
                        id="spot-form" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        {{-- title --}}
                        <div class="form-group mb-2">
                            <label for="title" class="form-label">Title</label>
                            <input type="text" id="title" name="title" placeholder="What unique spot did you find?"
                                class="input-box form-input" value="{{ old('title', $spot->title) }}">
                            @error('title')
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="file" id="main_image" name="main_image" class="form-control input-box"
                                aria-describedby="main_image-info">
                            @php
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea id="introduction" name="introduction" placeholder="This photo viewing introduction on spot page"
                                class="text-area" rows="8"> {{ old('introduction', $spot->introduction) }} </textarea>
                            @error('introduction')
                                <p class="mb-0 text-danger small">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                <div id="existing-images-wrapper" class="d-flex flex-wrap gap-2">
                                    ...
                                    @foreach ($images as $image)
                                        <div class="image-preview-box position-relative" data-image="{{ $image }}">
                                            ...
                                            <button type="button"
                                                class="btn btn-sm btn-danger position-absolute bottom-0 end-0 m-1 remove-existing-image">
                        ...
                        <input type="hidden" name="geo_location" id="geo_location"
                            value="{{ old('geo_location', $spot->geo_location) }}">
                </div>
                ...
                <div class="col-12 col-md-6 map-container">
                    ...
                    <div id="map" class="spot-map-container" data-lat="{{ old('geo_lat', $spot->geo_lat) }}"
