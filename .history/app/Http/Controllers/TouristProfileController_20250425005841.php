    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            $path = $request->file('avatar')
                ->store('images/profile/avatars', 'public');
            $user->avatar = $path;
        }
        // ヘッダ
        if ($request->hasFile('header')) {
            $path = $request->file('header')
                ->store('images/profile/headers', 'public');
            $user->header = $path;
        }
        ...
        return redirect()
            ->route('profile.header', ['id' => $user->id])
