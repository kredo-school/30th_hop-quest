<div class="row mx-0 px-0 align-items-stretch">
    ...
    <div class="col-md-4 px-0 order-1 order-md-2">
        <div
            class="bg-white rounded-3 d-flex flex-column justify-content-center border-navy border-2 px-3 m-0 py-1 ms-md-2 mb-3 mb-md-0">
            ...
            <div class="d-flex justify-content-center align-items-center w-100 fs-3">
                ...
                <div class="like-button-wrapper position-relative d-inline-block">
                    <button class="btn-like-toggle border-0 bg-transparent p-0 @guest like-disabled @endguest"
                        data-quest-id="{{ $quest_a->id }}" data-liked="{{ $quest_a->isLiked() ? '1' : '0' }}">
                        <i
                            class="fa{{ $quest_a->isLiked() ? 's' : 'r' }} fa-heart fs-3 like-icon {{ $quest_a->isLiked() ? 'text-danger' : '' }}"></i>
                    </button>
                    ...
                    <a class="like-count poppins-semibold text-decoration-none text-dark" data-bs-toggle="modal"
        ...
        <div class="row d-flex flex-wrap align-items-center bg-white rounded-3  h-100">
            ...
            <div class="col-auto m-2 align-items-center">
                ...
                <a href="#comment-section"
                    class="d-flex align-items-center mx-md-1 mx-lg-3 text-decoration-none text-dark">
            ...
            <div class="col-auto align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('profile.header', $quest_a->user->id) }}"
                        class="text-decoration-none h5 d-flex align-items-center my-0 me-3">
                        <h1 class="username h5 poppins-semibold mb-0 me-2" id="username">{{ $quest_a->user->name }}
                        </h1>

                        @if ($quest_a->user->official_certification == 3)
                            <img src="{{ asset('images/logo/official_personal.png') }}" alt="Official Badge"
                                style="height: 24px;" class="ms-1">
                        @endif
                    </a>
            ...
            <div class="col text-end">
                <div class="d-flex justify-content-end p-2">
                    @if (!empty($quest_a->user->instagram))
                        <a href="https://instagram.com/{{ $quest_a->user->instagram }}" class="text-decoration-none"
                            target="_blank" rel="noopener">
                            <i class="fa-brands fa-instagram text-dark icon-md mx-1"></i>
                        </a>
                    @endif
                    @if (!empty($quest_a->user->facebook))
                        <a href="https://facebook.com/{{ $quest_a->user->facebook }}" class="text-decoration-none"
                            target="_blank" rel="noopener">
                            <i class="fa-brands fa-facebook text-dark icon-md mx-1"></i>
                        </a>
                    @endif
                    @if (!empty($quest_a->user->x))
                        <a href="https://x.com/{{ $quest_a->user->x }}" class="text-decoration-none" target="_blank"
                            rel="noopener">
                            <i class="fa-brands fa-x-twitter text-dark icon-md mx-1"></i>
                        </a>
                    @endif
                    @if (!empty($quest_a->user->tiktok))
                        <a href="https://www.tiktok.com/@{{ $quest_a - > user - > tiktok }}" class="text-decoration-none"
                            target="_blank" rel="noopener">
