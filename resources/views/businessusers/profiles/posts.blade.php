        ...
        <div class="mb-5 row justify-content-center bg-blue">
            ...
            <div class="col-8 mb-3">
                <div class="row">
                    ...
                    @if ($user->id == Auth::user()->id)
                        <div class="col-2">
                            <a href="#" class="btn btn-sm btn-navy text-white mb-2 w-100"><i
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/kredocafeimage.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                {{-- <img src="{{ asset('images/Official Badge.png') }}" class="official" alt="official"> --}}
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/fireworks.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                            <div class="card-body content">
                                ...
                                <div class="row">
                                    <div class="col p-0">
                                        <p class="card_description">
                                            The Sumida River Fireworks Festival is one of Tokyo’s most spectacular and
                                            historic summer events. Held annually on the last Saturday of July, this
                                            breathtaking fireworks display lights up the night sky along the Sumida River,
                                            attracting over a million spectators.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/kredopubimage.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                            <div class="card-body content">
                                ...
                                <div class="row">
                                    <div class="col p-0">
                                        <p class="card_description">
                                            ...
                                            quisquam adipisci saepe cupiditate reprehenderit laborum consequatur incidunt
                                            necessitatibus temporibus? Suscipit, quos! Ipsam, qui veniam nemo debitis harum
                                            dolore voluptate fugit atque eius odit vero quibusdam quasi excepturi ipsum vel
                                            maxime nihil? Laudantium nisi dolore, alias aut hic consectetur itaque.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-8 mb-5">
                <div class="row">
                    ...
                    @if ($user->id == Auth::user()->id)
                        <div class="col-2">
                            <a href="{{ route('promotion.create') }}" class="btn btn-sm btn-navy text-white mb-2 w-100"><i
                                    class="fa-solid fa-plus"></i> ADD</a>
                        </div>
                    @endif
                </div>
                            ...
                            <div class="card p-3">
                                <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                    ...
                                    <a href="{{ route('promotion.show', $promotion->id) }}" class="">
                                        <img src="{{ $promotion->photo }}" class="card-img-top post-image"
                                            alt="image">
                                    </a>
                                </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-auto pe-0 ms-auto">
                                            <h5 class="card-subtitle">
                                                <span>{{ date('D, M d Y', strtotime($promotion->created_at)) }}</span></h5>
                                        </div>
                                    </div>
                                    {{-- Title --}}
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col p-0">
                                            ...
                                            @if ($promotion->promotion_start && $promotion->promotion_end)
                                                <h6 class="fw-bold">
                                                    {{ date('M d Y', strtotime($promotion->promotion_start)) }} ~
                                                    {{ date('M d Y', strtotime($promotion->promotion_end)) }}</h6>
                                                {{-- @else
                                <p>Day: -- --</p> --}}
                                            @endif
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col p-0">
                                                ...
                                                @if ($promotion->display_start && $promotion->display_end)
                                                    <p>Display period:
                                                        {{ date('M d Y', strtotime($promotion->display_start)) }} ~
                                                        {{ date('M d Y', strtotime($promotion->display_end)) }}</p>
                                                @else
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{ route('promotion.edit', $promotion->id) }}"
                                                    class="btn btn-sm btn-green fw-bold mb-2 w-100">EDIT</a>
                                            </div>
                                            <div class="col-6">
                                                @if ($promotion->trashed())
                                                    {{-- activate --}}
                                                    <button class="btn btn-outline-green w-100" data-bs-toggle="modal"
                                                        data-bs-target="#activate-promotion{{ $promotion->id }}">
                                                        UNHIDE
                                                    </button>
                                                @else
                                                    <button class="btn btn-red w-100" data-bs-toggle="modal"
                                                        data-bs-target="#deactivate-promotion{{ $promotion->id }}">
                                                        HIDE
                                                    </button>
                                                @endif
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                {{-- <img src="{{ asset('images/logo/OfficialBadge.png') }}" class="official" alt="official"> --}}
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/excursion.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                            <div class="card-body ">
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                {{-- <img src="{{ asset('images/logo/OfficialBadge.png') }}" class="official" alt="official"> --}}
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/seashore.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                            <div class="card-body ">
                    ...
                    <div class="col-4">
                        <div class="card p-3">
                            <div class="card-header border-0 bg-light p-0 overflow-hidden">
                                ...
                                {{-- <img src="{{ asset('images/logo/OfficialBadge.png') }}" class="official" alt="official"> --}}
                                <a href="#" class="">
                                    <img src="{{ asset('images/businessprofile/birdwatching.jpg') }}"
                                        class="card-img-top post-image" alt="image">
                                </a>
                            </div>
                            <div class="card-body ">
